						...
						<div class="panel" width="20px";>
							...
							<p class="panel-subtitle">Input information</p>
								...
								Retype password:
									...
									<label> 
										<input type="checkbox" name="add_supOrPro" value = "1" >
										<span>Add Supplier/Products</span>
										</label>
										&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;
										<label>
										<input type="checkbox" name="add_ReData" value="1">
										<span>Add Research Data</span>
									</label>
										<br>
									<label style="display:inline margin-left: 20px "">
										<input type="checkbox" name="vOrS_o_sudata" value = "1">
										<span>View/Search Own Suppliers</span>
										</label>
										&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<label>
										<input type="checkbox" name="vOrS_a_sudata" value = "1">
										<span>View/Search All Suppliers</span>
									</label>
									<br>
									<label style="display:inline margin-left: 20px "">
										<input type="checkbox" name="vOrS_o_redata" value = "1">
										<span>View/Search Own Research Data</span>
										</label>
										&emsp;
										<label>
										<input type="checkbox" name="vOrS_a_redata" value = "1">
