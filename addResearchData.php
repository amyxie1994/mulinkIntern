						...
						<div class="panel" width="20px";>
							...
							<p class="panel-subtitle">Input information</p>
								...
								Individual cost price:
									<br>
									<input type="text" class="form-control" id="indcost" name="indcost">
									<br>

								QTY ordered sample cost
									<br>
								...
								Sample Cost
									<br>
									<input type="text" class="form-control"  id="sampleCost" name="sampleCost">
									<br>

								Add on Item unit price
									<br>
